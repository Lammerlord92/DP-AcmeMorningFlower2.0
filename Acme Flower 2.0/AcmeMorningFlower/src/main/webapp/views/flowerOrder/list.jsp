...
<display:table name="flowerOrders" id="row" requestURI="${requestURI}" pagesize="5" class="displaytag">
	...
	<display:column title="${totalPrice}(${actual.name})">
	 	<jstl:out value="${row.totalPrice*actual.changeValue}"></jstl:out>
	 </display:column>
	...
	<spring:message code="flowerOrder.doughnut" var="doughnut"></spring:message>
	<display:column property="doughnut.name" title="${doughnut}" sortable="false"></display:column>
