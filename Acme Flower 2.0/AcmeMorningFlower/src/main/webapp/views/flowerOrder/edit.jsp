...
<fieldset>
	<legend align="left">
		...
		<form:label path="${totalPrice}">
			<b><spring:message code="flowerOrder.totalPrice" />(${actual.name})</b>
		</form:label>
		<jstl:out value="${flowerOrderForm.totalPrice*actual.changeValue}" />
...
<fieldset>
	...
	<acme:select itemLabel="name" items="${doughnuts}" code="flowerOrder.doughnut" path="doughnut"/>
